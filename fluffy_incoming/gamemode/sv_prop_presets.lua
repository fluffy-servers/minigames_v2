-- If you're adding new prop presets here, please remember to update the .fgd!
GM.PropPresets = {}
GM.PropPresets["Geometric"] = {
    models = {
...
GM.PropPresets["Geometric and Vehicles"] = {
    models = {
        "models/props_vehicles/van001a_physics.mdl",
        "models/props_vehicles/car001a_hatchback.mdl",
        "models/props_vehicles/car001b_hatchback.mdl",
...
GM.PropPresets["Cubes And Spheres"] = {
    models = {
