...
function SWEP:DrawHUD()
	...
	if mode != 1 then
        ...
        if GAMEMODE.DrawCrosshair then
            GAMEMODE:DrawCrosshair( ScrW()/2, ScrH()/2, 56, true )
            
            surface.SetDrawColor( 0, 0, 0, 255 )
            surface.DrawLine( 0, h * 0.5, w * 0.4, h * 0.5 )
            surface.DrawLine( w * 0.6, h * 0.5, w, h * 0.5 )
            surface.DrawLine( w * 0.5, 0, w * 0.5, h * 0.4 )
            surface.DrawLine( w * 0.5, h * 0.6, w * 0.5, h )
        else
