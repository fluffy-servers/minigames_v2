...
function GM:CreateTeams()
	...
	team.SetSpawnPoint( TEAM_RED, {"info_player_zombie", "info_player_terrorist", "info_player_combine"} )
	
	team.SetUp( TEAM_BLUE, "Survivors", Color( 80, 80, 255 ), true )
	team.SetSpawnPoint( TEAM_BLUE, {"info_player_counterterrorist", "info_player_rebel", "info_player_survivor"} )
