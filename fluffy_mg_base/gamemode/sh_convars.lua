...
-- Shared convars
    CreateConVar("mg_discord_ad", "https://discord.gg/UdMTckn", FCVAR_ARCHIVE + FCVAR_REPLICATED, "The discord url displayed when clicked on the motd")
    CreateConVar("mg_motd", "https://www.fluffyservers.com/guide/minigames.html", FCVAR_ARCHIVE + FCVAR_REPLICATED, "The text displayed on the motd")
