ITEM = {}
ITEM.VanillaID = 'paintable_balls'
ITEM.Name = 'Paintable Balls'
ITEM.Paintable = true
...
ITEM.Name = 'Paintable Snowflakes'
ITEM.Paintable = true
