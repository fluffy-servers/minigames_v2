...
function GM:CreateScoreboard(force)
	...
	function scoreboard:Paint(w, h)
		...
		-- I've had this todo here for over a year but I mean it I swear
...
function GM:UpdateMedals()
	...
	local num = 3
	if count <= 4 then num = 2 elseif count <= 2 then num = 1 end
...
function GM:ScoreboardShow()
	...
	if not GAMEMODE.Scoreboard:IsVisible() then GAMEMODE.Scoreboard:Appear() end
