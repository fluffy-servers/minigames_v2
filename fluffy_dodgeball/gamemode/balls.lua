...
-- Yay!
AddBall( "ball_base", "Rubber Ball", 2, 1, 0 ) -- default ball
AddBall( "ball_bouncy", "Bouncy Ball", 1, 1, 1 )
AddBall( "ball_zerograv", "Zero-Gravity Ball", 1, 1, 2 )
AddBall( "ball_rapidfire", "Rapidfire Balls", 10, 0.25, 3 )
AddBall( "ball_shotgun", "Shotgun", 1, 1, 4 )
AddBall( "ball_homing", "Homing Ball", 1, 2, 5 )
AddBall( "ball_shotgun", "(Improved) Shotgun", 1, 0.5, 7 )
AddBall( "ball_minigun", "Ball Minigun", 100, 0.125, 8 )
...
AddBall( "ball_shotgun", "Boomer", 1, 0.5, 3 )

-- Level 4
--AddBall( "ball_wrench", "More Wrenches", 5, 0.3, 4 )
AddBall( "ball_shotgun", "Baby Boomer", 1, 0.5, 4 )
